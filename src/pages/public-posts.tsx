...
import { getAllPublicPosts } from "@/services/post-service";
...
const PublicPosts = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full gap-3 overflow-auto">
      <div className="sticky flex flex-col w-full h-full items-center overflow-hidden">
        ...
        <div className="mt-5 flex flex-col">
          {loading ? (
            ...
            <Feed posts={filteredPosts} isPublic={true} />
          )}
        </div>
      </div>
    </div>
