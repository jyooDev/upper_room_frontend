          ...
          <div className="flex items-center justify-center gap-5">
            {isLoading ? (
              ...
              <>
                <div className="flex items-center space-x-4">
                  <L to="/login">
                    <button className="px-4 py-2 text-sm font-medium rounded-md text-white border-2 border-primary-50 bg-primary-50 hover:border-primary-100 hover:bg-primary-100">
                      Sign In
                    </button>
                  </L>
                </div>
                <div className="flex items-center space-x-4">
                  <L to="/signup">
                    <button className="px-4 py-2 text-sm font-medium rounded-md border-primary-100 bg-white border-2 hover:bg-gray-200">
                      Sign up
                    </button>
                  </L>
                </div>
