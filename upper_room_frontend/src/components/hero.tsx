          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col text-center gap-5">
              <div className="flex justify-center items-center bg-black/30 rounded-xl py-3 gap-2">
                <span className="text-white text-sm w-[35%] text-right">
                  Break Language Barriers
                </span>
                <span className="w-0.5 h-7 bg-white/30"></span>
                <span className="text-white w-[60%] text-left">
                  Worship translated into 50+ languages
                </span>
              </div>
              <div className="flex justify-center items-center bg-black/30 rounded-xl py-3 gap-2">
                <span className="text-white text-sm w-[35%] text-right">
                ...
                <span className="w-0.5 h-7 bg-white/30"></span>
                <span className="text-white w-[60%] text-left">
                  Private space for church members
                </span>
              </div>
              <div className="flex justify-center items-center bg-black/30 rounded-xl py-3 gap-2">
                <span className="text-white text-sm w-[35%] text-right">
                ...
                <span className="w-0.5 h-7 bg-white/30"></span>
                <span className="text-white w-[60%] text-left">
                  Join the wider community of faith
                </span>
              </div>
            </div>
          </div>
